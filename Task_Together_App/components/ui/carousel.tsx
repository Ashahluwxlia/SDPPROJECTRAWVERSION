    ...
    return (
      <div
        ...
        className={cn(
          ...
          isDemoMode && "border-r border-dashed border-muted-foreground/20 last:border-r-0",
          className
        )}
        {...props}
      />
...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, CarouselPreviousProps>(
  ({ className, variant = "outline", size = "icon", isDemoMode, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          ...
          isDemoMode && "border-dashed border-muted-foreground/30 text-muted-foreground",
          className
        )}
